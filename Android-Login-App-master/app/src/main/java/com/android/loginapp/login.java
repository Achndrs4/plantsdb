...
import com.android.database.LoginDBAdapter;
    ...
    private void LogMeIn(View v) {
    	...
    	if (theUser != null) {
    		...
    		if (theUser.getCount() > 0) {
    			saveLoggedInUId(theUser.getLong(theUser.getColumnIndex(LoginDBAdapter.COL_ID)), thisUsername, thePassword.getText().toString());
